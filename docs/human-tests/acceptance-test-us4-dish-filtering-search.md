...
| Q3 |  **Moderately likely** to use chips/search on a long digital menu again; would still **ask the waiter** for some menu information in person. **More likely** if the menu is very long or dietary filters matter; staff remains a default for “what should I know about this dish?” |
